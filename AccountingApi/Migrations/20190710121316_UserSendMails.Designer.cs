...
namespace AccountingApi.Migrations
{
    ...
    [Migration("20190710121316_UserSendMails")]
    partial class UserSendMails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountingApi.Models.ManualJournal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ManualJournals");
                });

            modelBuilder.Entity("AccountingApi.Models.OperationCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AccountingApi.Models.UserSendMailChangePassword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("UserSendMailChangePasswords");
                });
            ...
            modelBuilder.Entity("AccountingApi.Models.BalanceSheet", b =>
                {
                    ...
                    b.HasOne("AccountingApi.Models.ManualJournal", "ManualJournal")
                        .WithMany("BalanceSheets")
                        .HasForeignKey("ManualJournalId");
                });
            ...
            modelBuilder.Entity("AccountingApi.Models.ManualJournal", b =>
                {
                    ...
                    b.HasOne("AccountingApi.Models.OperationCategory", "OperationCategory")
                        .WithMany("ManualJournals")
            ...
            modelBuilder.Entity("AccountingApi.Models.UserSendMailChangePassword", b =>
                {
                    b.HasOne("AccountingApi.Models.User", "User")
                        .WithMany("UserSendMailChangePasswords")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
